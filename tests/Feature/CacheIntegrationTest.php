...
class CacheIntegrationTest extends TestCase
{
    ...
    #[Test]
    public function it_handles_findOrFail_with_cache()
    {
        // Create test data
        $post = Post::create([
            'title' => 'Test Post',
    ...
    #[Test]
    public function it_handles_withoutGlobalScope_queries_with_cache()
    {
    ...
    #[Test]
    public function it_handles_withoutGlobalScopes_queries_with_cache_invalidation()
    {
        PostWithGlobalScope::create([
            'title' => 'Published A',
            'content' => 'Content',
