...
class ConsoleCommandTest extends TestCase
{
    ...
    public function it_can_flush_cache_for_specific_model()
    {
        ...
        $this->artisan('mcache:flush', [
            ...
            ->expectsOutput('Attempting to clear cache for model: ' . Post::class)
            ->assertExitCode(0);
    }
    ...
    public function it_warns_when_model_does_not_use_trait()
    {
        ...
        $this->artisan('mcache:flush', [
            ...
            ->expectsOutput("Warning: The model {$modelClass} doesn't use HasCachedQueries trait. Cache functionality might be limited.")
            ->assertExitCode(0);
    }
    ...
    public function it_displays_cache_configuration()
    {
        ...
        $this->artisan('mcache:flush', [
            ...
            ->expectsOutput("Current cache driver: {$cacheDriver}")
            ->assertExitCode(0);
    }
}
