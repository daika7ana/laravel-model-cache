...
class ModelRelationshipsTest extends TestCase
{
    ...
    #[Test]
    public function it_uses_attachRelationshipAndFlushCache_method()
    {
        // Create test data
        $post = PostWithRelationships::create([
            'title' => 'Test Post',
    ...
    #[Test]
    public function it_uses_detachRelationshipAndFlushCache_method()
    {
        // Create test data
        $post = PostWithRelationships::create([
            'title' => 'Test Post',
    ...
    #[Test]
    public function it_uses_syncRelationshipAndFlushCache_method()
    {
        // Create test data
        $post = PostWithRelationships::create([
            'title' => 'Test Post',
    ...
    #[Test]
    public function it_handles_syncWithoutDetaching()
    {
        // Create test data
        $post = PostWithRelationships::create([
            'title' => 'Test Post',
    ...
    #[Test]
    public function it_handles_updateExistingPivot()
    {
    ...
    #[Test]
    public function it_creates_hasMany_relationship()
    {
        // Create test data
        $post = PostWithRelationships::create([
            'title' => 'Test Post',
    ...
    #[Test]
    public function it_invalidates_cache_on_hasMany_create()
    {
        // Create post
        $post = PostWithRelationships::create([
            'title' => 'Test Post',
    ...
    #[Test]
    public function it_invalidates_cache_on_hasMany_delete()
    {
    ...
    #[Test]
    public function it_invalidates_cache_on_hasMany_via_relationship()
    {
        // Create post
        $post = PostWithRelationships::create([
            'title' => 'Test Post',
    ...
    #[Test]
    public function it_creates_belongsTo_relationship_with_author()
    {
        // Create author
    ...
    #[Test]
    public function it_invalidates_cache_on_belongsTo_update()
    {
        // Create author
    ...
    #[Test]
    public function it_creates_hasMany_relationship_from_author()
    {
        // Create author
        $author = Author::create([
            'name' => 'John Doe',
    ...
    #[Test]
    public function it_creates_belongsTo_relationship_in_comment()
    {
        // Create post
        $post = PostWithRelationships::create([
            'title' => 'Test Post',
    ...
    #[Test]
    public function it_creates_hasManyThrough_relationship_from_author_to_comments()
    {
        $author = Author::create([
            'name' => 'Through Author',
    ...
    #[Test]
    public function it_invalidates_cache_on_hasManyThrough_create()
    {
        $author = Author::create([
    ...
    #[Test]
    public function it_invalidates_cache_on_hasManyThrough_update()
    {
        $author = Author::create([
    ...
    #[Test]
    public function it_invalidates_cache_on_hasManyThrough_delete()
    {
        $author = Author::create([
    ...
    #[Test]
    public function it_creates_hasOneThrough_relationship_from_author_to_first_comment()
    {
        $author = Author::create([
    ...
    #[Test]
    public function it_creates_hasOneOfMany_relationship_for_latest_comment()
    {
        $post = PostWithRelationships::create([
    ...
    #[Test]
    public function it_creates_direct_latestOfMany_relationship_for_latest_comment()
    {
        $post = PostWithRelationships::create([
    ...
    #[Test]
    public function it_invalidates_cache_on_hasOneOfMany_after_new_comment()
    {
        $post = PostWithRelationships::create([
    ...
    #[Test]
    public function it_invalidates_cache_on_hasOneOfMany_after_delete()
    {
        $post = PostWithRelationships::create([
    ...
    #[Test]
    public function it_invalidates_cache_on_hasOneOfMany_after_update()
    {
        $post = PostWithRelationships::create([
        ...
        usleep(1_100_000);
        $olderComment->update(['body' => 'Updated to become latest']);
